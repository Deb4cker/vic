...
public class CorrectImplementationMessages {
    ...
    public static final String CORRECT_IMPLEMENTATION_OF_METHOD = "Metodo %s";
    ...
    public static final String CORRECT_IMPLEMENTATION_OF_RELATIONSHIPS = "Todos os relacionamentos corretamente implementados! 🎉";

    private CorrectImplementationMessages() {}
}
